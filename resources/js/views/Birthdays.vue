  ...
  <div class="max-w-lg mx-auto space-y-6">
    ...
    <div v-if="showForm" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 px-4" @click.self="closeForm">
      <div class="bg-white rounded-xl p-6 w-full max-w-sm space-y-4">
        ...
        <button @click="save" class="w-full bg-primary text-white py-2.5 rounded-lg font-medium hover:bg-primary/90">
          Guardar
        </button>
...
onMounted(async () => {
  birthdays.value = await birthdayService.getBirthdays();
});
